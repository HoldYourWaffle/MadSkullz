...
public abstract class UtilMethods {
	...
	public static ItemStack getHead(Entity entity) {
		...
		if (entity instanceof EntitySkeleton || entity instanceof EntityZombie || entity instanceof EntityPlayer) { //ingame-skulls (or player skulls that don't have to be looked up in register)
